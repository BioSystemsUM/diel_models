...
if __name__ == '__main__':
    original_model = cobra.io.read_sbml_model(os.path.join("..", "..", "..", "examples", 'data', 'functional_tomato_model.xml'))
    diel_tomato_model = cobra.io.read_sbml_model(os.path.join("..", "..", "..", "examples", 'models', "diel_tomato_model_wo_nitrate.xml"))
