...
if __name__ == '__main__':
    original_model = cobra.io.read_sbml_model(os.path.join("..", "..", "..", "examples", 'models', 'Populus_iPop7188_fixed.xml'))
    diel_populus_model = cobra.io.read_sbml_model(os.path.join("..", "..", "..", "examples", 'models', "diel_populus_model_fixed_wo_nitrate.xml"))
