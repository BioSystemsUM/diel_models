...
if __name__ == '__main__':
    original_model = cobra.io.read_sbml_model(os.path.join("..", "..", "..", "examples", 'models', 'potato_mat.xml'))
    diel_potato_model = cobra.io.read_sbml_model(os.path.join("..", "..", "..", "examples", 'models', "diel_potato_model_wo_nitrate.xml"))
